...
class ShangQi3Cat(data.Dataset):
  num_classes = 3
  ...
  def __init__(self, opt, split):
    super(ShangQi3Cat, self).__init__()
...
if __name__ == '__main__':
  ...
  shangqi_coco = coco.COCO('/home/studentw/disk3/tracker/CenterNet/data/shangqi/val_merge_rider_and_person.json')
  shangqi_coco_dets = shangqi_coco.loadRes('/home/studentw/disk3/tracker/CenterNet/data/shangqi/results_rider2bike.json')
