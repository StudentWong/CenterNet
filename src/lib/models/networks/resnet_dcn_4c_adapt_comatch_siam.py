...
class CoMatch(nn.Module):
    ...
    def forward(self, xR, xT):
        ...
        # ret = h
        ret = torch.bmm(h, xT_O_self_NCC)/C
...
class PoseResNet(nn.Module):
    ...
    def __init__(self, block, layers, heads, head_conv):
        ...
        self.comatch_conv1 = CoMatch(64)

        self.layer1 = self._make_layer(block, 64, layers[0])
        self.comatch_layer1 = CoMatch(64)

        self.layer2 = self._make_layer(block, 128, layers[1], stride=2)
        self.comatch_layer2 = CoMatch(128)

        self.layer3 = self._make_layer(block, 256, layers[2], stride=2)
        self.comatch_layer3 = CoMatch(256)

        self.layer4 = self._make_layer(block, 512, layers[3], stride=2)
        self.comatch_layer4 = CoMatch(512)
    ...
    def forward(self, x):
        ...
        ret['comatch_xR_O'] = ret['comatch_xR_O'] + [xR]
        xR_G = self.comatch_layer1(xR, xT)
        ret['comatch_xR_G'] = ret['comatch_xR_G'] + [xR_G]
        ...
        xT = self.layer2(xT)
        ret['comatch_xR_O'] = ret['comatch_xR_O'] + [xR]
        xR_G = self.comatch_layer2(xR, xT)
        ret['comatch_xR_G'] = ret['comatch_xR_G'] + [xR_G]
        ...
        xR = self.layer3(xR)
        ret['comatch_xR_O'] = ret['comatch_xR_O'] + [xR]
        xR_G = self.comatch_layer3(xR, xT)
        ret['comatch_xR_G'] = ret['comatch_xR_G'] + [xR_G]
        ...
        xT = self.layer4(xT)
        ret['comatch_xR_O'] = ret['comatch_xR_O'] + [xR]
        xR_G = self.comatch_layer4(xR, xT)
        ret['comatch_xR_G'] = ret['comatch_xR_G'] + [xR_G]
