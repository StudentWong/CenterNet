...
def prefetch_test(opt):
  ...
  # print(opt.share_cut)
  model = create_model(opt.arch, opt.heads, opt.head_conv, adapt_thermal_weight=opt.adapt_thermal_weight, share_cut=opt.share_cut)
  stat_dict = torch.load(opt.load_model)["state_dict"]
